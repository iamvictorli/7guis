...
export function FieldButton(
  ...
  return (
    <button
      ...
      ref={ref}
      className={cn(
        '-ml-px rounded-r-md border px-2 outline-none transition-colors group-focus-within:border-[var(--accent-9)] group-focus-within:group-hover:border-[var(--accent-9)]',
