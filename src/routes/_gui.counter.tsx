  ...
  return (
    <>
      ...
      <Box
        my="5"
        position="relative"
        className="border-box bg-[var(--accent-2)] rounded-lg after:absolute after:content=[''] after:top-0 after:left-0 after:bottom-0 after:right-0 after:[box-shadow:0_0_0_1px_var(--gray-a5)] after:rounded-lg after:pointer-events-none">
        {/* Preview */}
