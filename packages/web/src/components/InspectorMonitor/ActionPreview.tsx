...
import type { PerformAction } from '@redux-devtools/core'
...
import type { DevtoolsInspectorState } from './redux'
...
function ActionPreview<S, A extends Action<string>>({
  delta,
  error,
  nextState,
  onInspectPath,
  ...
  const labelRenderer: LabelRenderer = (
    [key, ...rest],
    _nodeType,
    expanded,
  ) => {
