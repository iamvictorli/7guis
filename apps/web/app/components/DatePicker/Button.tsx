...
export function CalendarButton(props: AriaButtonProps<'button'>) {
  ...
  return (
    <button
      ...
      ref={ref}
      className={cn(
        'rounded-[var(--radius-thumb)] p-2 outline-hidden',
        isDisabled
          ? 'text-[var(--gray-6)]'
...
export function FieldButton(
  ...
  return (
    <button
      ...
      ref={ref}
      className={cn(
        '-ml-px rounded-r-[var(--radius-3)] border px-2 outline-hidden transition-colors group-focus-within:border-[var(--accent-9)] group-focus-within:group-hover:border-[var(--accent-9)]',
